  ...
  $('#comment-form').submit(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        showAlert('<strong>Thanks for your comment!</strong> It is <a href="https://github.com/lingxz/blog/pulls">currently pending</a> and will show on the site once approved.');
      },
      error: function (err) {
        console.log(err);
